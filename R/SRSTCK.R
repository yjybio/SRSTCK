...
#' test.SRSTCK <- SRSTCK(data = data, cancer = "CRC", type = "sc", cell_type = TME_cell_types, minGene = 500, maxGene = 5000, maxUMI = 40000, pctMT = 20, id.type = "S", cell.line = "no", ngene.chr = 5,  win.size = 25, KS.cut = 0.15, distance = "euclidean", n.cores = 1)
SRSTCK <- function (data, cancer, type, cell_type, minGene = 500, maxGene = 5000,
                    maxUMI = 40000, pctMT = 20, id.type = "S",
